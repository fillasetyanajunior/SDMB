...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            @php
                $id = $menuadmin->id;
                $menu = DB::table('accessadmins')
                        ->join('subadmins', 'accessadmins.sub_id','subadmins.id')
                        ->where('accessadmins.menu_id',$id)
                        ->orderBy('subadmins.title','asc')
                        ->get();
            @endphp     
            <li><a><i class="{{$menuadmin->icon}}"></i>{{$menuadmin->title}}<span class="fa fa-chevron-down"></span></a>
