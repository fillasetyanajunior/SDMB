                ...
                <div class="single_page">
                    ...
                    <div class="single_page_content">
                        <ul class="spost_nav">
                            @foreach ($comment as $comment)     
                                @if ($comment->post_id === $postkiprah->id)
                                <li>
                                    <p>{{$comment->comment}}</p>
                    ...
                    <div class="related_post">
                        ...
                        <form action="/coment" method="POST">
                            @csrf
                            <input type="hidden" name="hidden" value="kiprah">
                            <input type="hidden" name="hidden2" value="{{$postkiprah->id}}">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <aside class="right_content">
                <div class="single_sidebar">
                    <h2><span>Last Post Info Kiprah</span></h2>
                    <ul class="spost_nav">
