                ...
                <div class="single_page">
                    ...
                    <div class="single_page_content">
                        <ul class="spost_nav">
                            @foreach ($comment as $comment)     
                                @if ($comment->post_id === $postaisyiyah->id)
                                <li>
                                    <p>{{$comment->comment}}</p>
                    ...
                    <div class="related_post">
                        ...
                        <form action="/coment" method="POST">
                            @csrf
                            <input type="hidden" name="hidden" value="aisyiyah">
                            <input type="hidden" name="hidden2" value="{{$postaisyiyah->id}}">
