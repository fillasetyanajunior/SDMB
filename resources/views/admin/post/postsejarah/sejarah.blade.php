...
<div class="right_col" role="main">
    ...
    @endif
    <a href="/postsejarah/create" class="btn btn-primary my-3">Tambah Data</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="/postsejarah/{{$postsejarah->id}}" method="post" class="d-inline">
                            @method('delete')
                            @csrf
